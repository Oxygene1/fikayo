...
export function Logo({
  ...
  const accentColor = isScrolled ? "oklch(14.5% 0 0)" : "oklch(98.5% 0 0)";
  ...
  if (variant === "icon") {
    return (
      ...
      >
        ...
        <path d="M14 12H28V16H18V21H26V25H18V36H14V12Z" fill={accentColor} />
  ...
  return (
    <div className={`flex flex-col items-center gap-4 ${className}`}>
      ...
      <div className="text-center">
        <h1 className={`text-2xl font-bold ${textColor} mb-1`}>
          Fikayomi Duke Famakinwa
        </h1>
  ...
  return (
    ...
    >
      <rect
        ...
        fillOpacity="0.1"
      />
      <path d="M14 12H28V16H18V21H26V25H18V36H14V12Z" fill="#4F46E5" />
      <path
        d="M30 12H36C39.866 12 43 15.134 43 19V29C43 32.866 39.866 36 36 36H30V12ZM34 16V32H36C37.6569 32 39 30.6569 39 29V19C39 17.3431 37.6569 16 36 16H34Z"
        fill="#0F172A"
      />
