  ...
  const projects = [
    {
      ...
      description: 'Led the end-to-end implementation of an ERP system for a Fortune 500 company, coordinating between 50+ stakeholders and managing a $2M budget. Delivered 3 weeks ahead of schedule with 20% cost savings.',
      image: 'https://images.unsplash.com/photo-1608222351212-18fe0ec7b13b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMGFuYWx5dGljcyUyMGRhc2hib2FyZHxlbnwxfHx8fDE3NjgyMjY4MzB8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    ...
    },
    {
      ...
      description: 'Orchestrated a comprehensive digital transformation strategy for a healthcare provider, including process re-engineering, system integration, and staff training. Improved patient satisfaction by 35%.',
      image: 'https://images.unsplash.com/photo-1627634771105-08a3a12ad228?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9qZWN0JTIwbWFuYWdlbWVudCUyMHRlYW18ZW58MXx8fHwxNzY4MTYzOTQzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    ...
    },
    {
      ...
      description: 'Managed the deployment of a centralized data analytics platform, conducting extensive requirements analysis and user acceptance testing. Enabled real-time decision making across 5 departments.',
    ...
    },
    {
      ...
      description: 'Conducted comprehensive business analysis and led process improvement initiatives for a global supply chain operation. Reduced operational costs by 18% and improved delivery times by 25%.',
            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="grid grid-cols-3 gap-4 mb-4 py-4 border-t border-b border-gray-200">
                  ...
                  <div className="text-center">
                    <ExternalLink size={20} className="mx-auto text-blue-600 mb-1" />
                    <p className="text-xs text-gray-500">Outcome</p>
                    <p className="text-sm font-semibold text-gray-900">{project.outcome}</p>
                  </div>
                </div>
