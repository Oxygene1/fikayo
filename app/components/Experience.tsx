  ...
  const workExperience = [
    {
      ...
      period: '2021 - Present',
      description: 'Leading multiple high-impact projects with budgets exceeding $5M. Implementing agile methodologies and driving digital transformation initiatives across the organization.',
      achievements: [
    ...
    },
    {
      ...
      period: '2018 - 2021',
      description: 'Spearheaded business analysis efforts and managed end-to-end project delivery. Collaborated with C-level executives to align projects with strategic objectives.',
      achievements: [
    ...
    },
    {
      ...
      period: '2016 - 2018',
      description: 'Conducted requirements gathering, process modeling, and gap analysis for enterprise-level clients. Facilitated workshops and created comprehensive documentation.',
      achievements: [
    ...
    <section id="experience" className="py-20 bg-gradient-to-br from-blue-50 to-indigo-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <p className="text-blue-600 font-medium text-sm uppercase tracking-wider mb-3">Journey</p>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Experience & Education
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            A career built on continuous growth, learning, and delivering exceptional results
          </p>
        </div>
          ...
          <div>
            ...
            <div className="space-y-8">
              {education.map((edu, index) => (
                <div key={index} className="relative pl-8 border-l-2 border-indigo-300">
